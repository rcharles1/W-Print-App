package com.example.wprintapp.modules.settings.`data`.model
...
data class SettingsModel(
   ...
   * TODO Replace with dynamic value
   */
  var txtStewieGriffin: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_stewie_griffin)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtEmail: String? = MyApp.getInstance().resources.getString(R.string.msg_stewiegriffin_g)
  ,
  /**
   * TODO Replace with dynamic value
   */
